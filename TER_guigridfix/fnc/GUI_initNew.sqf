...
//--- Functions
GUI_path = gettext (configfile >> "RscGUIEditor" >> "path");
GUI_fnc_compile = {
	...
	GUI_fnc_gridSet = compile preprocessfilelinenumbers ("TER_guigridfix\fnc\GUI_fnc_gridSetNew.sqf");
